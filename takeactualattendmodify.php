...
$query = "SELECT * 
    ...
    LEFT JOIN tb_program ON tb_program.prog_id = tb_actualattendance.programId
    LEFT JOIN tb_session ON tb_session.session_id = tb_actualattendance.sessionId
    LEFT JOIN tb_staff ON tb_staff.s_id = tb_actualattendance.s_id
    WHERE tb_actualattendance.s_id='$user_id' AND tb_actualattendance.sessionId='$classn'";
